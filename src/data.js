...
export const STRINGS = {
  en: {
    ...
    tabs:["Stats","Matchup","Abilities","Evolutions","Moves","GO Moves","Sprites","Breeding","Locations"],
  ...
  th: {
    ...
    tabs:["สถิติ","ตารางประเภท","ความสามารถ","วิวัฒนาการ","สกิล","GO Moves","สไปรท์","เพาะพันธุ์","แหล่งที่พบ"],
  ...
  ja: {
    ...
    tabs:["種族値","タイプ相性","特性","進化","わざ","GO技","スプライト","タマゴ","生息地"],
